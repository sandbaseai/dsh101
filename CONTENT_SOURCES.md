...
| Tool development, canonical output/presentation boundaries, and the execution pipeline through frozen authoritative result | `docs/user/develop/basic/tool.zh.md`, `docs/subsystems/tools.zh.md`, `docs/tool-execution-pipeline.zh.md`, `packages/core/tools/README.zh.md` |
