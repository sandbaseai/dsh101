...
const requiredSections = ['quickstart', 'install', 'headless', 'inspect-config', 'model', 'onboarding', 'model-selection-state', 'workspace', 'workspace-list', 'directory-picker', 'new-session', 'session-row-status', 'session-log', 'agent-delivery', 'session-queue', 'permissions', 'permission-presets', 'approval-flow', 'sandbox', 'e2b-runtime', 'python', 'plugins', 'tools', 'tool-call-tree', 'config-schema', 'events', 'lifecycle', 'client-modules', 'ui-slots', 'slot-injection', 'client-hmr', 'plugin-inventory', 'scope-routing', 'web-server', 'web-api-security', 'native-open-boundary', 'connection-recovery', 'typert-remote', 'capability-seam', 'llm-adapter', 'llm-streaming', 'llm-retry', 'max-tokens', 'dynamic-extensions', 'code-runtime', 'profiles', 'profile-hot-reload', 'settings-system', 'settings-safe-update', 'schema-form', 'settings-file-lifecycle', 'credentials-system', 'credential-file-security', 'launch-environment', 'agent-presets', 'prompt-assembly', 'workspace-instructions', 'time-context', 'tmux-context', 'mcp', 'skills', 'plan-mode', 'web-tools', 'attachments', 'attachment-ui', 'deliverables', 'user-questions', 'user-question-lifecycle', 'filesystem-seam', 'file-search', 'shell-terminal', 'subprocess-seam', 'lsp-navigation', 'commands', 'input-triggers', 'hooks', 'schedule', 'workflows', 'token-meter', 'context-meter', 'trajectory', 'telemetry', 'anonymous-id', 'invariants', 'feedback', 'subagents', 'todos', 'goals', 'compaction', 'guardrails', 'guardrail-semantics', 'background-jobs', 'session-history', 'browser-session-search', 'session-reference', 'session-title', 'session-management', 'archive-convergence', 'persistence', 'session-projection', 'storage-domains', 'atomic-file-write', 'spill-output']
