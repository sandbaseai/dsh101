...
const changed = execFileSync('git', [
  ...
  'packages/client/ui-settings', 'packages/client/ui-settings-models', 'packages/client/ui-settings-plugins', 'packages/client/schema-form', 'packages/client/ui-model-selection',
  ...
  'packages/attachment', 'packages/client/ui-attachment', 'packages/client/ui-deliverables', 'packages/jobs', 'docs/subsystems/attachment.zh.md',
  ...
  'packages/settings', 'packages/credentials', 'packages/preset', 'packages/util/launch-environment',
  'docs/subsystems/settings.zh.md', 'docs/subsystems/credentials.zh.md', 'packages/boot/app-boot',
  'docs/subsystems/system-prompt.zh.md', 'packages/context/agent-instructions', 'packages/context/time-context', 'packages/context/tmux-context',
  ...
  'docs/subsystems/client-modules.zh.md', 'packages/client/modules', 'packages/client/ui-slots', 'packages/client/hmr',
  ...
  'packages/client/ui-conversation', 'packages/client/ui-tool', 'packages/client/ui-trajectory', 'packages/client/ui-workspace', 'packages/client/ui-input-trigger', 'packages/client/ui-commands',
