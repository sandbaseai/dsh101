...
const requiredSections = ['quickstart', 'install', 'model', 'workspace', 'permissions', 'sandbox', 'python', 'plugins', 'tools', 'config-schema', 'events', 'lifecycle', 'capability-seam', 'llm-adapter', 'profiles', 'mcp', 'skills', 'plan-mode', 'web-tools', 'attachments', 'user-questions', 'shell-terminal', 'lsp-navigation', 'commands', 'hooks', 'schedule', 'workflows', 'subagents', 'todos', 'goals', 'compaction', 'guardrails', 'background-jobs', 'session-history', 'persistence', 'storage-domains', 'spill-output']
