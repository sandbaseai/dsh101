...
const requiredSections = ['quickstart', 'install', 'model', 'workspace', 'session-log', 'permissions', 'permission-presets', 'approval-flow', 'sandbox', 'python', 'plugins', 'tools', 'config-schema', 'events', 'lifecycle', 'client-modules', 'scope-routing', 'web-server', 'typert-remote', 'capability-seam', 'llm-adapter', 'llm-streaming', 'dynamic-extensions', 'profiles', 'settings-system', 'credentials-system', 'agent-presets', 'prompt-assembly', 'mcp', 'skills', 'plan-mode', 'web-tools', 'attachments', 'user-questions', 'filesystem-seam', 'shell-terminal', 'subprocess-seam', 'lsp-navigation', 'commands', 'hooks', 'schedule', 'workflows', 'token-meter', 'telemetry', 'invariants', 'feedback', 'subagents', 'todos', 'goals', 'compaction', 'guardrails', 'background-jobs', 'session-history', 'session-reference', 'session-title', 'persistence', 'session-projection', 'storage-domains', 'spill-output']
