...
const requiredSections = ['quickstart', 'install', 'headless', 'inspect-config', 'model', 'onboarding', 'workspace', 'directory-picker', 'session-log', 'agent-delivery', 'session-queue', 'permissions', 'permission-presets', 'approval-flow', 'sandbox', 'e2b-runtime', 'python', 'plugins', 'tools', 'config-schema', 'events', 'lifecycle', 'client-modules', 'plugin-inventory', 'scope-routing', 'web-server', 'web-api-security', 'connection-recovery', 'typert-remote', 'capability-seam', 'llm-adapter', 'llm-streaming', 'llm-retry', 'max-tokens', 'dynamic-extensions', 'code-runtime', 'profiles', 'settings-system', 'settings-safe-update', 'schema-form', 'credentials-system', 'agent-presets', 'prompt-assembly', 'workspace-instructions', 'time-context', 'tmux-context', 'mcp', 'skills', 'plan-mode', 'web-tools', 'attachments', 'attachment-ui', 'deliverables', 'user-questions', 'user-question-lifecycle', 'filesystem-seam', 'file-search', 'shell-terminal', 'subprocess-seam', 'lsp-navigation', 'commands', 'input-triggers', 'hooks', 'schedule', 'workflows', 'token-meter', 'context-meter', 'telemetry', 'anonymous-id', 'invariants', 'feedback', 'subagents', 'todos', 'goals', 'compaction', 'guardrails', 'guardrail-semantics', 'background-jobs', 'session-history', 'session-reference', 'session-title', 'session-management', 'persistence', 'session-projection', 'storage-domains', 'spill-output']
