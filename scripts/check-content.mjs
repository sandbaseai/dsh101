...
const requiredSections = ['quickstart', 'install', 'model', 'workspace', 'permissions', 'approval-flow', 'sandbox', 'python', 'plugins', 'tools', 'config-schema', 'events', 'lifecycle', 'capability-seam', 'llm-adapter', 'profiles', 'settings-system', 'credentials-system', 'agent-presets', 'prompt-assembly', 'mcp', 'skills', 'plan-mode', 'web-tools', 'attachments', 'user-questions', 'shell-terminal', 'lsp-navigation', 'commands', 'hooks', 'schedule', 'workflows', 'token-meter', 'telemetry', 'invariants', 'feedback', 'subagents', 'todos', 'goals', 'compaction', 'guardrails', 'background-jobs', 'session-history', 'session-title', 'persistence', 'session-projection', 'storage-domains', 'spill-output']
