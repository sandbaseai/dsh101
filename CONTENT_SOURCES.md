...
| Extension mechanism selection, runtime ownership, tool policy hook choice, UI/protocol drivers, MCP tool discovery, Skill disclosure, and durable-state boundaries | `docs/cookbook/extension-cookbook.zh.md`, `docs/architecture.zh.md`, `docs/subsystems/tools.zh.md`, `docs/subsystems/skills.zh.md`, `packages/mcp/mcp-client/README.zh.md` |
...
| Vendored Cordis package publication names, preserved protocol identifiers, mechanical rescoping, regeneration requirements, reverse migration, and hygiene verification | `docs/rescope.zh.md`, `vendor/README.md`, `scripts/rescope-vendor.ts` |
...
| Layered testing evidence, per-file coverage limits, keyless composition snapshots, browser replay, real-provider e2e, external-world assertions, regression-guard validation, built entry points, and record-versus-refresh policy | `docs/testing.zh.md`, `docs/development.zh.md`, `docs/postmortem/0001-acp-default-export-drops-inject.zh.md`, `docs/postmortem/0002-js-expression-disabled-filesystem-tools.zh.md` |
...
| End-to-end request journey, Cordis service ownership, Turn/Step admission, persistent facts, live coordination, capability seams, and replayable Web/SDK projections | `docs/architecture.zh.md`, `docs/agent-lifecycle.zh.md`, `docs/subsystems/core.zh.md`, `docs/subsystems/session.zh.md`, `packages/host/apiproxy/README.zh.md` |
...
| Browser ConversationNode incremental assembly, extension delivery path, stable business identity, pending updates, checkpoint fallback, typed Location data, prepend identity, gap repair, frame-coalesced streaming, and replay-equivalence tests | `docs/cookbook/adding-a-conversation-node.zh.md`, `packages/client/runtime/README.zh.md`, `packages/client/ui-conversation/README.zh.md` |
