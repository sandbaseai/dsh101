...
requiredSections.push('api-gateway-lifecycle')
...
requiredSections.push('persistence-catalog')
requiredSections.push('cordis-runtime-model')
requiredSections.push('contributor-delivery')
requiredSections.push('web-styling')
requiredSections.push('testing-evidence')
requiredSections.push('request-journey')
requiredSections.push('conversation-node-extension')
requiredSections.push('extension-choice')
requiredSections.push('vendor-rescope')
requiredSections.push('glossary')
