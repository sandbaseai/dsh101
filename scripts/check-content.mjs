...
const requiredSections = ['quickstart', 'install', 'model', 'workspace', 'permissions', 'approval-flow', 'sandbox', 'python', 'plugins', 'tools', 'config-schema', 'events', 'lifecycle', 'client-modules', 'capability-seam', 'llm-adapter', 'llm-streaming', 'dynamic-extensions', 'profiles', 'settings-system', 'credentials-system', 'agent-presets', 'prompt-assembly', 'mcp', 'skills', 'plan-mode', 'web-tools', 'attachments', 'user-questions', 'shell-terminal', 'lsp-navigation', 'commands', 'hooks', 'schedule', 'workflows', 'token-meter', 'telemetry', 'invariants', 'feedback', 'subagents', 'todos', 'goals', 'compaction', 'guardrails', 'background-jobs', 'session-history', 'session-title', 'persistence', 'session-projection', 'storage-domains', 'spill-output']
...
for (const marker of ['Sandbox modes', 'Approval lifecycle', 'Python SDK quickstart', 'Configuration schema', 'Event system', 'Web client modules', 'Capability roles', 'LLM adapters', 'Streaming and retries', 'Dynamic runtime extensions', 'Connect an MCP server', 'Skill discovery and loading', 'Layered settings', 'Credential references', 'Agent presets', 'Persona and prompt assembly', 'Web search and fetch', 'Image attachments', 'Ask the user', 'Shell and persistent terminals', 'Precise LSP code navigation', 'Slash commands', 'Codex and Claude Code hooks', 'Session-local reminders', 'Workflows and Ralph', 'Token metering', 'Session telemetry', 'Runtime invariants', 'Message feedback', 'Subagent delegation', 'Persistent goals', 'Context compaction', 'Tool guardrails', 'Background jobs', 'Session search and log export', 'Durable session titles', 'Session persistence and recovery', 'Session projections and cold reads', 'Domain storage for non-session data', 'Oversized tool results and spill', 'Content provenance']) {
