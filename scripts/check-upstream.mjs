...
const changed = execFileSync('git', [
  ...
  'packages/client/ui-conversation', 'packages/client/ui-trajectory', 'packages/client/ui-workspace', 'packages/client/ui-input-trigger', 'packages/client/ui-commands',
