...
const requiredSections = ['quickstart', 'install', 'model', 'workspace', 'python', 'plugins', 'tools', 'config-schema', 'events', 'lifecycle', 'capability-seam', 'llm-adapter', 'profiles', 'mcp', 'skills', 'plan-mode', 'web-tools', 'subagents', 'todos', 'goals', 'compaction']
...
for (const marker of ['Python SDK quickstart', 'Configuration schema', 'Event system', 'Capability roles', 'LLM adapters', 'Connect an MCP server', 'Skill discovery and loading', 'Web search and fetch', 'Subagent delegation', 'Persistent goals', 'Context compaction', 'Content provenance']) {
