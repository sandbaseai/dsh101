...
const requiredSections = ['quickstart', 'install', 'model', 'workspace', 'python', 'plugins', 'tools', 'config-schema', 'events', 'lifecycle', 'capability-seam', 'llm-adapter', 'profiles']
...
for (const marker of ['Python SDK quickstart', 'Configuration schema', 'Event system', 'Capability roles', 'LLM adapters', 'Content provenance']) {
